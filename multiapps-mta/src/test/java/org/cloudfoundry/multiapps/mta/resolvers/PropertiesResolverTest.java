...
class PropertiesResolverTest {
    ...
    static Stream<Arguments> testResolve() {
        return Stream.of(
            Arguments.of("list-in-map", "${test-map/a-list/1}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#test-map/a-list/1\"")),
            Arguments.of("map-in-list", "${test-list/0/foo}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#test-list/0/foo\"")),
            Arguments.of("map-in-list-extra-slash", "${test-list/0/foo/}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#test-list/0/foo/\"")),
            Arguments.of("complex-value", "${test-list/1}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#test-list/1\"")),
            Arguments.of("simple-value", "${test-list/2}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#test-list/2\"")),
            Arguments.of("first-in-list", "${hosts/0/}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#hosts/0/\"")),
            ...
            Arguments.of("corner-case-map-and-list", "${tricky-map/0/1}",
                         new Expectation(Expectation.Type.EXCEPTION, "Unable to resolve \"test-#tricky-map/0/1\"")),
            ...
            Arguments.of("circular-ref-map", "${CIRCULAR_REF_MAP_IN_MAP/key/key}",
                         new Expectation(Expectation.Type.EXCEPTION, "Circular reference detected in \"test-#circular-ref-map\""))
        );
    }
