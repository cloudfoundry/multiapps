...
public final class Messages {
    ...
    public static final String POPULATED_TASK_EXECUTION_COLUMN_IN_PROGRESS_MESSAGE_TABLE = "The 'task_execution_id' column in the 'progress_message' table was populated successfully!";
