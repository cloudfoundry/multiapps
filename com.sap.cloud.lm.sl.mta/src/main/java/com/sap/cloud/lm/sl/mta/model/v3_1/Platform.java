...
public class Platform extends com.sap.cloud.lm.sl.mta.model.v3_0.Platform {
    ...
    private List<PlatformModuleType> moduleTypes3_1;
    private List<PlatformResourceType> resourceTypes3_1;
    ...
    public static class Builder extends com.sap.cloud.lm.sl.mta.model.v3_0.Platform.Builder {
        ...
        public Platform build() {
            ...
            result.setModuleTypes3_1(ObjectUtils.defaultIfNull(moduleTypes3_1, Collections.<PlatformModuleType> emptyList()));
            result.setParameters(ObjectUtils.defaultIfNull(parameters, Collections.<String, Object> emptyMap()));
            result.setResourceTypes3_1(ObjectUtils.defaultIfNull(resourceTypes3_1, Collections.<PlatformResourceType> emptyList()));
            return result;
        }
