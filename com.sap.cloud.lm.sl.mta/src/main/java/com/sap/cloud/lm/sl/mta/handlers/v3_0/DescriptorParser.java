...
public class DescriptorParser extends com.sap.cloud.lm.sl.mta.handlers.v2_0.DescriptorParser {
    ...
    protected ExtensionDescriptorParser getExtensionDescriptorParser(Map<String, Object> map) {
        return new com.sap.cloud.lm.sl.mta.parsers.v3_0.ExtensionDescriptorParser(map);
    }
    ...
    protected DeploymentDescriptorParser getDeploymentDescriptorParser(Map<String, Object> map) {
        return new com.sap.cloud.lm.sl.mta.parsers.v3_0.DeploymentDescriptorParser(map);
    }
