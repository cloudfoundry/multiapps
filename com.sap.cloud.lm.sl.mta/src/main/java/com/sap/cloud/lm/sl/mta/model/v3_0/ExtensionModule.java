...
public class ExtensionModule extends com.sap.cloud.lm.sl.mta.model.v2_0.ExtensionModule {
    ...
    public static class Builder extends com.sap.cloud.lm.sl.mta.model.v2_0.ExtensionModule.Builder {
        ...
        public ExtensionModule build() {
            ...
            result.setName(name);
            result.setProvidedDependencies3_0(ObjectUtils.defaultIfNull(providedDependencies3_0, Collections.<ExtensionProvidedDependency> emptyList()));
            result.setRequiredDependencies3_0(ObjectUtils.defaultIfNull(requiredDependencies3_0, Collections.<ExtensionRequiredDependency> emptyList()));
