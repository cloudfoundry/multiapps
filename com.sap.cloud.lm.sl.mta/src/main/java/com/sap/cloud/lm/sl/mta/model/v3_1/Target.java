...
public class Target extends com.sap.cloud.lm.sl.mta.model.v3_0.Target {
    ...
    public static class Builder extends com.sap.cloud.lm.sl.mta.model.v3_0.Target.Builder {
        ...
        public Target build() {
            ...
            result.setModuleTypes3_1(ObjectUtils.defaultIfNull(platformModuleTypes3_1, Collections.<TargetModuleType> emptyList()));
            result.setParameters(ObjectUtils.defaultIfNull(parameters, Collections.<String, Object> emptyMap()));
            result.setResourceTypes3_1(ObjectUtils.defaultIfNull(platformResourceTypes3_1, Collections.<TargetResourceType> emptyList()));
            return result;
        }
