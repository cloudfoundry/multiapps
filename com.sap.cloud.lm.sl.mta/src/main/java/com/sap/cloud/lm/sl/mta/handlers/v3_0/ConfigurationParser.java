...
import com.sap.cloud.lm.sl.mta.parsers.v3_0.TargetParser;
import com.sap.cloud.lm.sl.mta.parsers.v3_0.PlatformParser;
import com.sap.cloud.lm.sl.mta.schema.SchemaValidator;

public class ConfigurationParser extends com.sap.cloud.lm.sl.mta.handlers.v2_0.ConfigurationParser {
    ...
    public List<Platform> parsePlatformTypesJson3_0(String json) throws ParsingException {
        return ListUtil.cast(super.parsePlatformsJson(json));
    }

    public List<Platform> parsePlatformTypesJson3_0(InputStream json) throws ParsingException {
        return ListUtil.cast(super.parsePlatformsJson(json));
    }

    @Override
    protected PlatformParser getPlatformParser(Map<String, Object> source) {
        return new com.sap.cloud.lm.sl.mta.parsers.v3_0.PlatformParser(source);
    }

    public List<Target> parsePlatformsJson3_0(String json) throws ParsingException {
        return ListUtil.cast(super.parseTargetsJson(json));
    }

    public List<Target> parsePlatformsJson3_0(InputStream json) throws ParsingException {
        return ListUtil.cast(super.parseTargetsJson(json));
    }
    ...
    protected TargetParser getDeployTargetParser(Map<String, Object> source) {
        return new com.sap.cloud.lm.sl.mta.parsers.v3_0.TargetParser(source);
    }
