...
public class ExtensionDescriptor extends com.sap.cloud.lm.sl.mta.model.v3_0.ExtensionDescriptor {
    ...
    public static class ExtensionDescriptorBuilder
        ...
        public ExtensionDescriptor build() {
            ...
            result.setResources3_1(getOrDefault(resources3_1, Collections.<ExtensionResource> emptyList()));
            result.setDeployTargets(getOrDefault(deployTargets, Collections.<String> emptyList()));
            result.setParameters(getOrDefault(parameters, Collections.<String, Object> emptyMap()));
            result.setModules3_1(getOrDefault(modules3_1, Collections.<ExtensionModule> emptyList()));
            return result;
        }
