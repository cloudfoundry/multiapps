package com.sap.cloud.lm.sl.mta.validators.v3_1;
...
public class DeploymentDescriptorValidator extends com.sap.cloud.lm.sl.mta.validators.v2_0.DeploymentDescriptorValidator {
    ...
    public void visit(ElementContext context, RequiredDependency requiredDependency) throws ContentException {
        ...
        com.sap.cloud.lm.sl.mta.model.v3_1.RequiredDependency requiredDependencyV3 = cast(requiredDependency);
    ...
    public void visit(ElementContext context, Resource resource) throws ContentException {
        ...
        com.sap.cloud.lm.sl.mta.model.v3_1.Resource resourceV3 = cast(resource);
    ...
    public void visit(ElementContext context, com.sap.cloud.lm.sl.mta.model.v1_0.Module module) throws ContentException {
        ...
        com.sap.cloud.lm.sl.mta.model.v3_1.Module moduleV3 = cast(module);
    ...
    public void visit(ElementContext context, ProvidedDependency providedDependency) throws ContentException {
        ...
        com.sap.cloud.lm.sl.mta.model.v3_1.ProvidedDependency providedDependencyV3 = cast(providedDependency);
