...
// @formatter:off
            ...
            {
                "/mta/sample/v1_0/mtad-01.yaml", new String[] { "/mta/sample/v1_0/config-01.mtaext", }, "R:/mta/sample/v1_0/merged-04.yaml.json",
            },
            // (1) Valid deployment and extension descriptors (multiple):
            {
                "/mta/sample/v1_0/mtad-01.yaml", new String[] { "/mta/sample/v1_0/config-01.mtaext", "/mta/sample/v1_0/config-05.mtaext", }, "R:/mta/sample/v1_0/merged-05.yaml.json",
            },
// @formatter:on
        });
    }
