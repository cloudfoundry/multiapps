...
public class DescriptorParserTest extends com.sap.cloud.lm.sl.mta.handlers.v1_0.DescriptorParserTest {
...
// @formatter:off
            ...
            {
                "/mta/sample/v2_0/mtad-01.yaml", "/mta/sample/v2_0/config-01.mtaext", new String[] { "R:mtad-01.yaml.json", "R:config-01.mtaext.json", },
            },
            // (1) Valid deployment and extension descriptors for version 1 of MTA specification:
            {
                "/mta/sample/v1_0/mtad-01.yaml", null, new String[] { "E:Invalid type for key \"modules#0#requires#0\", expected \"Map\" but got \"String\"", "S", },
            },
            ...
            {
                "/mta/sample/v2_0/mtad-05.yaml", null, new String[] { "R:mtad-01.yaml.json", "S", },
            },
