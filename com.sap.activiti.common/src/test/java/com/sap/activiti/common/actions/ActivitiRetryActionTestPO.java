...
public class ActivitiRetryActionTestPO {
	...
	public Object getVariable(String variableName) {
		HistoricVariableInstance variable = ActivitiTestCfgRuleChain.getActivitiRule().getHistoryService()
	...
	public void removeFailureVariable() {
		ActivitiTestCfgRuleChain.getActivitiRule().getRuntimeService().removeVariable(processInstanceId, FAIL.name());
	}

	private String getFailedJob() {
		return ActivitiTestCfgRuleChain.getActivitiRule().getManagementService().createJobQuery()
