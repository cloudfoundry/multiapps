...
public class DelegateExecutionSkipHelperTest {
    ...
    public void creatingSkipRequests() {
        ...
        assertEquals(ISkipHelper.SkipRequest.SKIP.toString(), context.getVariable(AbstractSkipHelper.SKIP_STEP_PREFIX + "step1"));

        assertEquals(ISkipHelper.SkipRequest.SKIP.toString(), context.getVariable(AbstractSkipHelper.SKIP_STEP_PREFIX + "step2"));
    }
    ...
    public void removingSkipRequests() {
        ...
        assertEquals(ISkipHelper.SkipRequest.NONE.toString(), context.getVariable(AbstractSkipHelper.SKIP_STEP_PREFIX + "step1"));
