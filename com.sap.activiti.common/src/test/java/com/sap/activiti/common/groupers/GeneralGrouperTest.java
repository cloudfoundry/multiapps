...
public class GeneralGrouperTest {
    ...
    public void testGroupingByCriteria() {
        ...
        assertThat(groupedInstances.get("17")
            .size(), is(2));
        assertThat(pageObject.getGroupNames(groupedInstances.get("17")), containsInAnyOrder("Ivan", "Elena"));

        assertThat(groupedInstances.get("25")
            .size(), is(2));
        assertThat(pageObject.getGroupNames(groupedInstances.get("25")), containsInAnyOrder("John", "Andrey"));

        assertThat(groupedInstances.get("35")
            .size(), is(1));
        assertThat(pageObject.getGroupNames(groupedInstances.get("35")), containsInAnyOrder("Lora"));
    }
}